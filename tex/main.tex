...
\textbf{Propositional logic tutors…, ORGANON (have to be on uncg proxy), Croy, ...}
...
\subsubsection{Precedence Mapping Example} We will use the same functions $f$ and $g$ from the first propositional logic example. We will also define $\Gamma$ as
\begin{align*}
	& f:\;\{\supset,\,\land,\,\lor,\,\leftrightarrow,\,\lnot\}\mapsto \{I,\,C,\,D,\,B,\,N\} \\
	& g:\;\{A,\,B,\,C\} \mapsto \{a_{1},\,a_{2},\,a_{3}\} \\
