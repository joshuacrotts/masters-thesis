...
\usepackage{booktabs, pifont, wrapfig, lscape, float, rotating, epstopdf, amsmath, amssymb, amsfonts, amsthm, graphicx, booktabs, syntax, subcaption, algorithm, tabularx}
\usepackage{siunitx}
...
\usepackage{microtype} % Fixes the "Missing font type" error.
\makeatletter
...
\textbf{Show a table and describe different notation by different authors?}
...
The study was implemented as two Qualtrics surveys. The first consisted of ten\footnote{\url{https://github.com/JoshuaCrotts/MastersThesis/data/qualtrics\_survey\_1.txt}} carefully-selected pairs of premises that either prove the same conclusion, or a slightly-altered version of the conclusion. The second survey contained ten\footnote{\url{https://github.com/JoshuaCrotts/MastersThesis/data/qualtrics\_survey\_2.txt}} pairs of proofs where each proof in the pair derives the same conclusion, but take different approaches to doing so. Finally, we had a third component where students would use our ANDTaP system (see section \ref{section:andtap}) to prove ten natural deduction problems\footnote{\url{https://github.com/JoshuaCrotts/MastersThesis/data/andtap\_questions.txt}}. A cheat-sheet of all rules was provided. We would measure how long the student took to solve the proof (provided they were able to), what rules were utilized, and what mistakes were made. Participants who fully completed the study were entered into a drawing to win a \$50 Amazon Gift Card.
